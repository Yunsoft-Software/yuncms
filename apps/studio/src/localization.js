...
export const PT_BR = Object.freeze({ ...BASE_PT_BR, ...UI_PT_BR, ...UX_PT_BR, ...AI_PT_BR, ...MCP_PT_BR, ...NAVIGATION_PT_BR, ...REGISTRATION_PT_BR, ...STUDIO_NEXT_PT_BR });
export const JA = Object.freeze({ ...BASE_JA, ...UI_JA, ...UX_JA, ...AI_JA, ...MCP_JA, ...NAVIGATION_JA, ...REGISTRATION_JA, ...STUDIO_NEXT_JA });
export const ZH_CN = Object.freeze({ ...BASE_ZH_CN, ...UI_ZH_CN, ...UX_ZH_CN, ...AI_ZH_CN, ...MCP_ZH_CN, ...NAVIGATION_ZH_CN, ...REGISTRATION_ZH_CN, ...STUDIO_NEXT_ZH_CN });
